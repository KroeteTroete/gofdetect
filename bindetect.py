...
@overload
def detectStrings(binFile: FilePathType, binType: BinType, returnType: Literal['list']) -> List[str]: ...
@overload
def detectStrings(binFile: FilePathType, binType: BinType, returnType: Literal['string']) -> str: ...
@overload
def detectStrings(binFile: FilePathType, binType: BinType, returnType: Literal['list', 'string'] = 'string') -> str: ...
